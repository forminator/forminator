...
export const DictInputDispatchContext = createContext<DictInputDispatchContextType | undefined>(undefined);
...
export function useDictInputDispatchContext(): DictInputDispatchContextType {
  ...
  if (context === undefined) {
    throw new Error('useDictInputDispatchContext must be used inside the <DictInputDispatchContextProvider/>');
  }
  return context;
}
...
export function DictInputDispatchContextProvider(props: Props) {
  return <DictInputDispatchContext.Provider value={props.value}>{props.children}</DictInputDispatchContext.Provider>;
}
